...
public class LoginServiceTest {
	...
	public void checkBadUserTest() {
		...
		int returnedId = loginService.checkUser(user);
		System.out.println(returnedId);
		assertTrue(".checkUser() should return a userId of 0 if user is not in database.", returnedId == 0);
	}
	...
	public void createBadExistingUserTest() {
		...
		assertTrue(".createUser() should return a userId of 0 if user is already in database.", returnedId == 0);
	}
	...
	public void createBadLongUserTest() {
		...
		int returnedId = loginService.createUser(user);
		System.out.println(returnedId);
		assertTrue(".creatUser() should return a userId of -1 if username is too long.", returnedId == -1);
	}
	...
	public void createUserBadPassTest() {
		...
		int returnedId = loginService.createUser(user);
		System.out.println(returnedId);
		assertTrue(".creatUser() should return a userId of -2 if the password is too short.", returnedId == -2);
	}
	...
	public void createGoodUserTest() {
		...
		int returnedId = loginService.createUser(user);
		System.out.println(returnedId);
		assertTrue(".creatUser() should return a  positive userId if user is created.", returnedId == 1);
	}
}
